            ...
            <main className="min-h-screen bg-[#121212] text-white">
                ...
                <section className="py-16 px-4 bg-[#1E1E1E]">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <h2 className="text-3xl font-bold mb-4">Hecho en Colombia 🇨🇴</h2>
                        <p className="text-gray-300 mb-8">
                            Nuestra oficina principal está en Barranquilla, con equipos
                            distribuidos en Bogotá, Medellín y Cali.
                        </p>
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#E53935]/20 rounded-full text-[#E53935]">
...
function ValueCard({
    ...
    return (
        <div className="bg-[#212121] rounded-xl p-6 text-center">
            <div className="w-14 h-14 bg-[#E53935]/20 rounded-full flex items-center justify-center mx-auto mb-4">
